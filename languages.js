...
const translations = {
    ...
    "de": {
        ...
        // Kurzbefehle
        "shortcutsText": "Kurzbefehle",
        "enableShortcutsText": "Gespeicherte Kurzbefehle zeigen",
        "editShortcutsText": "Kurzbefehle bearbeiten",
        "editShortcutsList": "Gespeicherte Kurzbefehle",
        "shortcutsInfoText": "Wählen, welche Kurzbefehle angezeigt werden",
        "adaptiveIconText": "Angepasste Symbolformen",
        "adaptiveIconInfoText": "Symbole werden rund angezeigt",
        "ai_tools_button": "AI-Tools",
        "enable_ai_tools": "Kurzbefehle für AI-Tools zeigen",
        // Digitale Uhr
        "digitalclocktittle": "Digitale Uhr",
        "digitalclockinfo": "Zur digitalen Uhr wechseln",
        "timeformattittle": "12-Stunden-Format",
        "timeformatinfo": "12-Stunden-Zeitformat verwenden",
        "greetingtittle": "Begrüßung",
        "greetinginfo": "Begrüßung unter benutzerdefiniertem Text anzeigen",
        // Sonstiges
        "userTextTitle": "Anpassbarer Text",
        "userTextInfo": "Benutzerdefinierten Text unter der Uhr zeigen",
        "fahrenheitCelsiusCheckbox": "Zu Fahrenheit wechseln",
        "fahrenheitCelsiusText": "Seite aktualisieren, um Änderungen zu übernehmen",
        ...
        "useproxyText": "Falls Suchvorschläge nicht funktionieren",
        "ProxyText": "CORS-Umgehungsproxy",
        "ProxySubtext": "Eigenen CORS-Umgehungsproxy hinzufügen",
        "HostproxyButton": "Eigenen Proxy hosten",
        "saveproxy": "Speichern",
        // Standort
        "UserLocText": "Standort eingeben",
        "UserLocSubtext": "Falls der Wetterstandort nicht stimmt",
        "userLoc": "Ihre Stadt oder Koordinaten (Breite, Länge)",
        "InputOptionsButton": "Eingabeoptionen",
        "saveLoc": "Speichern",
        // Wetter
        "WeatherApiText": "Geben Sie Ihren WeatherAPI-Schlüssel ein",
        "WeatherApiSubtext": "Falls die Wetterfunktion nicht funktioniert",
        "userAPI": "Ihr WeatherAPI-Schlüssel",
        "LearnMoreButton": "Mehr erfahren",
        "saveAPI": "Speichern",
        // Ende der Menü-Elemente
        ...
        // Neues Tab-Element
        "conditionText": "Hallo! Wie geht es Ihnen heute?",
        "enterBtn": "Suchen",
        "searchPlaceholder": "Ihre Anfrage...",
        "searchWithHint": "Suchen mit",
        "ai_tools": "AI-Tools",
        "userText": "Hier klicken zum Bearbeiten",
        // Ende der Tab- und Body-Elemente
